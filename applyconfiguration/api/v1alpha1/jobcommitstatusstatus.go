...
// JobCommitStatusStatusApplyConfiguration represents a declarative configuration of the JobCommitStatusStatus type for use
// with apply.
//
// JobCommitStatusStatus defines the observed state of JobCommitStatus.
type JobCommitStatusStatusApplyConfiguration struct {
	...
	Environments []JobCommitStatusEnvironmentStatusApplyConfiguration `json:"environments,omitempty"`
...
// JobCommitStatusStatusApplyConfiguration constructs a declarative configuration of the JobCommitStatusStatus type for use with
// apply.
func JobCommitStatusStatus() *JobCommitStatusStatusApplyConfiguration {
	return &JobCommitStatusStatusApplyConfiguration{}
}

// WithObservedGeneration sets the ObservedGeneration field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the ObservedGeneration field is set to the value of the last call.
func (b *JobCommitStatusStatusApplyConfiguration) WithObservedGeneration(value int64) *JobCommitStatusStatusApplyConfiguration {
...
func (b *JobCommitStatusStatusApplyConfiguration) WithEnvironments(values ...*JobCommitStatusEnvironmentStatusApplyConfiguration) *JobCommitStatusStatusApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *JobCommitStatusStatusApplyConfiguration) WithConditions(values ...*v1.ConditionApplyConfiguration) *JobCommitStatusStatusApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *JobCommitStatusStatusApplyConfiguration) WithInstanceID(value string) *JobCommitStatusStatusApplyConfiguration {
	b.InstanceID = &value
	return b
}
